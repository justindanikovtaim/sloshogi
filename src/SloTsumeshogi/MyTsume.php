...
while ($row = mysqli_fetch_array($result)) : ?>
    <a class='problemList' href='/slotsumeshogi/tsume?id=<?php echo $row[' id'] ?>'>#<?php echo $row[' id'] ?> <?php echo $row['problemName'] ?> by <?php echo $row['createdBy'] ?></a>
    <a class='problemList' href='/slotsumeshogi/edit-tsume?id=<?php echo $row[' id'] ?>'><button>編集</button></a>
